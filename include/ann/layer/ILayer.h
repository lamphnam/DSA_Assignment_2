...
public:
    ...
    virtual void set_working_mode(bool mode = true) {
        m_trainable = mode;
    };
    ...
    virtual int register_params(IParamGroup *ptr_group) {
        return 0;
    } // default: 0=no learnable parameters
    ...
    virtual bool has_learnable_param() {
        return false;
    };
