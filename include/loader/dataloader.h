...
class DataLoader {
 public:
  class Iterator {
   public:
    Iterator(DataLoader &data_loader, int batch_index)
        : data_loader(data_loader), batch_index(batch_index) {}
 ...
 public:
  ...
  Batch<DType, LType> get_batch(int batch_index) {
    ...
    for (int i = start_index; i < end_index; ++i) {
      ...
      DataLabel<DType, LType> data_label =
          ptr_dataset->getitem(index);  
